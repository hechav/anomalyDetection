...
class AnomalyPruner:
	...
	# def get_fingerprint(self, feats_cat=[""]):
	# 	temp = df[feats_cat]
	# 	temp
	# 	output = df[feats_cat].mean()
	# 	return output
...
# # defino fingerprint
# feats_fingerprint = ["content_type","proto","countrycode","response"] # alrededor de 16 variables
# pruned.tst_pruned

# print(pruner.random_seed)
# print(pruner.url_df)
# print(pruner.mean_length_histogram)
# print(pruner.tst_pruned_dummies)
# print(pruner.tst_pruned)
# print(pruner.ml_engine_features)
# print()
